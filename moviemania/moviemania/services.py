...
def find_a_movie(form):
    ...
    # The URL looks like :
    # https://www.omdbapi.com/?i=tt3896198&t=Firefly&type=series&apikey=d82bf903

    url = 'http://www.omdbapi.com/?i=tt3896198&t={0}&type={1}&apikey=d82bf903'.format(
        search_key, choice)
